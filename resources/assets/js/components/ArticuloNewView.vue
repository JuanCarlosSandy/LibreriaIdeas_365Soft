            ...
            <form>
                <div class="form-group row">
                    <div class="col-md-6">
                        <div>
                            ...
                            <InputText id="nombreProducto" v-model="datosFormulario.nombre" placeholder="Ej. Lapicero Azul" class="form-control p-inputtext-sm" :class="{'p-invalid' : errores.nombre}" @input="validarCampo('nombre')"/>
                ...
                <div v-if="agregarStock && tipoAccion == 1" class="form-group row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="p-inputgroup">
                            <InputText id="almacen" v-model="almacenSeleccionado" placeholder="Seleccione un almacen" class="form-control p-inputtext-sm bold-input" disabled
